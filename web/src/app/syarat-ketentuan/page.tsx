...
const sections = [
  ...
  { id: "bagian-8", number: "8", title: "Larangan" },
  { id: "bagian-9", number: "9", title: "Pembatasan Tanggung Jawab" },
  { id: "bagian-10", number: "10", title: "Penghentian" },
  { id: "bagian-11", number: "11", title: "Perubahan S&K" },
  { id: "bagian-12", number: "12", title: "Hukum yang Berlaku" },
  { id: "bagian-13", number: "13", title: "Kontak" },
];
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-12 lg:gap-12">
            ...
            <article className="lg:col-span-9">
              <div className="space-y-12 text-neutral-800">
                ...
                <Article id="bagian-8" number="8" title="Larangan">
                  <p>
                ...
                <Article id="bagian-10" number="10" title="Penghentian">
                  <p>
                ...
                <Article id="bagian-12" number="12" title="Hukum yang Berlaku">
                  <p>
                ...
                <Article id="bagian-13" number="13" title="Kontak">
                  <p>
