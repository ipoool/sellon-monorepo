...
export default async function PengaturanWhatsAppPage() {
  ...
  // outbound WA alerts). Templates are still editable EXCEPT the order-alert
  // one (managed by the form itself).
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <WhatsAppTemplatesForm initial={templatesRes?.templates ?? {}} plan={plan} />
    </div>
  );
}
